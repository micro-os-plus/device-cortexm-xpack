...
- name the post like: **µOS++ devices-cortexm v2.0.0 released**
...
- `npm dist-tag add @micro-os-plus/devices-cortexm@2.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/devices-cortexm`
...
- paste the release name like **µOS++ devices-cortexm v2.0.0 released**
